    ...
    <div class="table-responsive">
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <form action="{{ route('sanggar.index') }}" method="GET">
                </form>
            </div>
        </div>
            ...
            <tbody>
                @foreach ($sanggar as $item)
                    <tr>
                        ...
                        @if (auth()->user()->role == 'superadmin')
                            <td>
                                <a href="{{ route('sanggar.edit', $item->id) }}" class="btn btn-primary">Edit</a>
                                <form action="{{ route('sanggar.delete', $item->id) }}" method="POST"
